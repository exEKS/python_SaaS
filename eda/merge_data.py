...
def finish_job():
    input_folder = 'Дані'
    print("🚀 Оновлюю дані: об'єдную звіти ISW (без URL) та додаю регіони...")
    ...
    try:
        ...
        print(f"✅ 2_isw.csv готовий (об'єднано {len(isw_files)} файлів, посилання видалено)")
        ...
        print("\n🎉 ТЕПЕР ТОЧНО ВСЕ! Файли готові до відправки.")
